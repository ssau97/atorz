...
import { philosophyData } from "@/utlits/fackData/philosophyData";
          ...
          <div className="row">
            <div className="col-lg-12">
              <Swiper
                ...
                modules={[Navigation]}
              >
                {philosophyData.map(({ id, title, position, review, src }) => (
                  <SwiperSlide key={id}>
                    {" "}
                    <Card
                      img={src}
    ...
    <SlideUp>
      <div className="testimonial-item">
        <div className="author">
          <Image width={128} height={128} sizes="100vw" src={img} alt="" />
        </div>
