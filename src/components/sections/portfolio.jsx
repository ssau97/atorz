            ...
            <div className="col-xl-12 col-lg-12">
              <SlideUp>
                <div className="section-title text-center">
                  ...
                  <p>
                    Bridging digital and physical realms through strategic
                    design. Explore our commitment to redefining boundaries and
        ...
        <div className="project-item style-two">
          <div className="project-image">
            <Image
              ...
              alt="Project"
            />
            <Link href="/single-project" className="details-btn">
              <RiArrowRightUpLine />{" "}
            </Link>
          </div>
